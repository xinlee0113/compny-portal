    ...
    this.products = [
      {
        id: 'product-001',
        name: '核心产品A',
        description: '这是我们的核心产品A，具有高性能、高可靠性等特点，广泛应用于各行各业。',
      ...
      },
      {
        id: 'product-002',
        name: '核心产品B',
        description: '产品B是我们专为特定行业设计的解决方案，具有定制化程度高、适应性强等优势。',
      ...
      },
      {
        id: 'product-003',
        name: '核心产品C',
        description: '产品C是我们最新推出的一款创新型产品，采用先进技术，满足未来发展趋势。',
      ...
      },
      {
        id: 'solution-001',
        name: '制造业数字化转型解决方案',
        description: '专为制造业打造的数字化转型完整解决方案，提升生产效率和管理水平。',
      ...
      },
      {
        id: 'solution-002',
        name: '智慧城市解决方案',
        description: '构建智慧城市的综合性解决方案，涵盖交通、安防、环保等多个领域。',
      ...
      },
      {
        id: 'service-001',
        name: '系统集成服务',
        description: '专业的系统集成服务，帮助企业整合各类技术系统，提升整体效率。',
      ...
      },
      {
        id: 'service-002',
        name: '技术咨询与支持',
        description: '提供专业的技术咨询和全方位的技术支持服务，保障系统稳定运行。',
